...
public class PDFGenerator extends DriverFactory {
	...
	*/
    ...
    try {
        ...
        PdfWriter.getInstance(document,new FileOutputStream(new File(".//src//main//Table.pdfTable.pdf")));
        document.open();
        ...
        Image logo = Image.getInstance(".//src//main//logo-exame.png");
	...
	*/
	 ...
	 */
	public void fechaPDF(String Texto) throws DocumentException, IOException  {
	
		
		if (cenarioLocal.isFailed()) {
	...
	document.add(new Paragraph("Status: " + cenarioLocal.getStatus(), colorFailed));
	...
	document.add(new Paragraph("Status: " + cenarioLocal.getStatus(), colorPassed));
